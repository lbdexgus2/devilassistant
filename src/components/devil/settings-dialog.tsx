...
import { LANGUAGE_LABELS, useI18n, type Language } from "@/lib/i18n";
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-6 py-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="model">{t.depth}</Label>
            <Select
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              <Label htmlFor="thinking">{t.showThinking}</Label>
              <p className="text-xs text-muted-foreground">{t.showThinkingHint}</p>
            </div>
            <Switch
              id="thinking"
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              <Label htmlFor="dense">{t.compact}</Label>
              <p className="text-xs text-muted-foreground">{t.compactHint}</p>
            </div>
            <Switch
              id="dense"
          ...
          <div className="flex items-center justify-between gap-4 border-t border-border pt-4">
            <p className="min-w-0 truncate text-sm text-muted-foreground">{email ?? t.signedIn}</p>
            <Button
              variant="outline"
              size="sm"
              className="gap-2"
